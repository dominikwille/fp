...
Plotting these values gives us a slope of m = 0.225.\\
\\
...
So it's clear that lead has the highest absorption coefficient. These results seem realistic to us too.\\
\\
Investigating the plot of the measurement of $^{60}$Co leads us to the result that our experimental values for the energy are almost the literaric ones.
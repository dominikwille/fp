...
%\myImage[8cm]{img/cal}{Result of our measurement for aborptions coefficient of Al}
...
%\myImage[8cm]{img/cal}{Result of our measurement for aborptions coefficient of Cu}
...
%\myImage[8cm]{img/cal}{Result of our measurement for aborptions coefficient of Pb}
...
Before calibrating this detector, we had to switch some cables and turn the detector on. To calibrate the Ge-detector we took again $^{60}$Co, $^{137}$Cs,$^{22}$Na and $^{241}$Am. We measured each of those elements for three minutes

\subsection{1 hour measurement of $^{137}$Cs}
To get a high resolution of a spectrum of $^{60}$Co, we took the probe and measured the radiation for one hour. Our result is shown in the following graphic.

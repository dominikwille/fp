...
Mathematisch betrachtet kann man also sagen, dass man in der Transmissionsholographie eine Photoplatte benutzt, um ein Interferenzmuster aus der \textit{Objektwelle} $S$ und der \textit{Referenzwelle} $R$ zu speichern. 

\myImage[9cm]{img/trans}{Schema der Transmissionsholographie}
...
Bei Rekonstruktion erhält dass man das Ausgangsbild wieder, wenn man Licht der gleichen Wellenlänge einfallen lässt. Für die Amplitude einer Lichtwelle auf die Photoplatte gilt:
\begin{align}
